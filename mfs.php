...
<div class="col-md-12">
    <div class="card">
        <div class="header">
            <h4 class="title"><b>Product on Hand</b></h4>
        </div>
        <div class="content">
                <div class="row">
                    <div class="col-md-6">
                 ...
                 <div class="row">
                    ...
                    <form action="bll/bll.mfs.php" method="POST">
                ...
                <!-- Hold end -->
                    <div class="col-md-6">
                        <input type="text" name="mfsId" value="<?php
                            if(isset($_GET['edit']))
                               echo $GLOBALS['mfsId'];
                            ?>" style="display: none;">
                <div class="form-group">
...
<div class="card">
    <div class="header">
        <h4 class="title"><b>Product on Hand</b> 
        </h4>
    </div>
    <div class="content">
    <form  method="GET">
...
<!-- Hold end -->
    ...
    <div class="row">
         <div class="col-md-8">
            <div class="form-group">
                <label>&nbsp;</label>
                <input type="submit" name="dateRange" class="btn btn-info btn-fill pull-right" value="Load Product on Hand">
            </div>
        </div>
...
if (isset($_GET['SE']) && isset($_GET['dateRange']))
{
    ...
    $dateTo = $_GET['dateTo'];
    echo $bllMFS->showSEMFS($_GET['SE'],$dateFrom,$dateTo);
}
elseif (isset($_GET['SE']))
{
    $time = time();
    $today = date('Y-m-d',$time);
    echo $bllMFS->showSEMFS($_GET['SE'],$today,$today);
}
elseif(isset($_GET['dateRange']))
{
    $dateFrom = $_GET['dateFrom'];
    $dateTo = $_GET['dateTo'];
    echo $bllMFS->showMFS($dateFrom,$dateTo);
}
...
else
{
    $time = time();
    $today = date('Y-m-d',$time);
    echo $bllMFS->showMFS($today,$today);
}
?>
